module.exports = function( grunt ) {
	...
	var globalConfig = {
		...
		styles_src : 'scss/',
		styles     : '../assets/css/',
		textdomain : 'template-based-meta-boxes'
	};
		...
		makepot     : {
			pot: {
				options: {
					cwd        : '..',
					exclude    : [ 'resources' ],
					mainFile   : 'template-based-meta-boxes.php',
					potComments: 'Copyright (C) {{year}} Template-based Meta Boxes\nThis file is distributed under the same license as the Template-based Meta Boxes package.',
					potFilename: '<%= globalConfig.textdomain %>.pot',
					potHeaders : {
						poedit                 : true,
						'report-msgid-bugs-to' : 'https://github.com/tfrommen/template-based-meta-boxes/issues',
